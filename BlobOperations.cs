...
namespace OpsgilityBlob01
{
    public class BlobOperations
    {
        string storageAccountName = "teststorage203";
        string storageAccountKey = "OEu6TV+7jDJSzkwZEKthYxLwmuDLYxm1mw1+Ttp30aBirMKEqJZVG3Xi4vBnm/5dR1erpK1qGu5YKkfimdVRwA==";
        ...
        {
            //make the container name unique so if you run this over and over, you won't have any problems with the latency of deleting a container.
            ...
            //get reference to the cloud blob client (this is used to access the storage account blobs and containers)
        ...
        private string GetFileNameFromBlobURI(Uri theUri, string containerName)
        {
            ...
            string oneFile = theFile.Substring(dirIndex + containerName.Length + 1, theFile.Length - (dirIndex + containerName.Length + 1));
